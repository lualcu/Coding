...
public void almacenaDatos(Canino c) {
	...
	ImageIcon icon= new ImageIcon(img.getScaledInstance(70, 70, Image.SCALE_SMOOTH));
		...
		File arch = new File("/Users/alexdelacueva/Desktop/JAVA/OOP/Ficheros/canino.txt");
		...
		try {
			...
			if(arch.exists()) 
			{
				...
				fichero = new FileOutputStream("/Users/alexdelacueva/Desktop/JAVA/OOP/Ficheros/canino.txt", true);
				...
				fichero = new FileOutputStream("/Users/alexdelacueva/Desktop/JAVA/OOP/Ficheros/canino.txt");
				// Cambia el Archivo a Objeto para Serializar 
				archivo = new ObjectOutputStream(fichero);
			}
