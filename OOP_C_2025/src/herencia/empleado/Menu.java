...
public class Menu {
	...
	public void menuIngresa() {
		do {
		opc = Integer.parseInt((String)JOptionPane.showInputDialog(null, "1.- Mantenimiento\n"
				+ "2.- Informatico\n"
				+ "3.- Director\n"
		...
		switch(opc) {
			case 1:
				i.ingresaMantenimiento();
				break;
			case 2:
				i.ingresaInformatico();
				break;
			case 3:
				i.ingresaDirector();
				break;
	...
	public void menuConsulta() {
		do {
			...
			switch(opc) {
				case 1:
					c.consultaMantenimiento();
					break;
				case 2:
					c.consultaInformatico();
					break;
				case 3:
					c.consultaDirector();
					break;
