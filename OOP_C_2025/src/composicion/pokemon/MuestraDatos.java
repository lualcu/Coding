...
public class MuestraDatos {
	...
	public void muestraDatos (Pokemon p) {
		...
		datos += p.nombre + "\t" + p.especie + "\t" + p.tipo + "\t" + p.habitat + "\t" + p.peso + "\t" + p.altura + "\n";
		// Colocar la Variable Datos en un JTextArea
		salida.setText(datos);
		JOptionPane.showMessageDialog(null, salida, "Reporte de Pokemon´s", JOptionPane.INFORMATION_MESSAGE);
	}
